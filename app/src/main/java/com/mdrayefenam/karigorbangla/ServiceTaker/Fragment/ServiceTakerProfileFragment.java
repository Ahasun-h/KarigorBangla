 ...
 */
public class ServiceTakerProfileFragment extends Fragment {
    ...
    public ServiceTakerProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        update_profile.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent( getContext(), ServiceTakerProfileUpdate.class );
