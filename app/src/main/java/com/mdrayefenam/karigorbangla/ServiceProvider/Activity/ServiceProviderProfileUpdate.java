...
public class ServiceProviderProfileUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_service_provider_profile_update );
...
//                                Toast.makeText( ServiceProviderProfileUpdate.this, "Profile Update", Toast.LENGTH_SHORT).show();
//
...
//
//                                Intent intent = new Intent( ServiceProviderProfileUpdate.this,ServiceProviderHome.class );
//                                startActivity( intent );
                                ...
                                Toast.makeText( ServiceProviderProfileUpdate.this, "Error", Toast.LENGTH_SHORT).show();

                                profile_update.setVisibility( View.VISIBLE );
                                progress_bar.setVisibility( View.GONE );
                            }
                        } else {
                            Toast.makeText( ServiceProviderProfileUpdate.this, "", Toast.LENGTH_SHORT).show();
    ...
    void showDialog() {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( ServiceProviderProfileUpdate.this, LoginActivity.class );
                startActivity( intent );
                alertDialog.dismiss();
            }
        });
